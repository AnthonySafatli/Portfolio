...
![File Dashboard Screenshot](/projects/images/admin-file-dashboard.png)

The file manager dashboard provides a comprehensive overview of all media files used across the website, including screenshots, videos, logos and markdown/json files.

![Upload Screenshot](/projects/images/admin-upload-dashboard.png)

The admin section also lets you upload anything you would need to seemlessly. This includes adding a project to the database, uploading/updating a markdown/json script for a project and uploading images/videos.
